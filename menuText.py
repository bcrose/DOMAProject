...
class menu:
    ...
    line2 = myfont.render('Welcome! Catch coins as the Buddha', False, (0, 0, 0))
    line3 = myfont.render('Build Karma for each coin you catche', False, (0, 0, 0))
    line4 = myfont.render('Earn 100 karma for a museum secret', False, (0, 0, 0))
    line5 = myfont.render('Press spacebar to throw', False, (0, 0, 0))
